...
bool Initialize(size_t argc, LPCTSTR* argv)
{
	...
	config.add_options()
		...
		("global-seam-leveling", boost::program_options::value<bool>(&OPT::bGlobalSeamLeveling)->default_value(false), "generate uniform texture patches using global seam leveling")
